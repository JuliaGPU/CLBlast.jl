...
for (func, elty) in [(:CLBlastStrmv, Float32), (:CLBlastDtrmv, Float64),
                     (:CLBlastCtrmv, Complex64), (:CLBlastZtrmv, Complex128)]
    ...
    @eval function $func(layout::CLBlastLayout, triangle::CLBlastTriangle,
        ...
        err = ccall(
            ...
            cl.CL_int,
            (Cint, Cint, Cint, Cint, Csize_t, Ptr{Void}, Csize_t, Csize_t,
